...
//___________________新添加__________________________________________
    INDEX_TEMPLATE_ARGUMENTS
    void BPlusTreeLeafPage<KeyType, ValueType, KeyComparator>::
 ...
 */
    ...
    CopyFirstFrom(const MappingType &item, int parentIndex,
        ...
        // get parent
        auto parent = reinterpret_cast<BPlusTreeInternalPage<KeyType, decltype(GetPageId()),
